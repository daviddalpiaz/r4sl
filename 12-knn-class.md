...
The `rmarkdown` file for this chapter can be found [**here**](12-knn-class.Rmd). The file was created using `R` version 3.4.4. The following packages (and their dependencies) were loaded when knitting this file:
