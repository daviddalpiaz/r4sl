...
![](04-reg-basics_files/figure-latex/unnamed-chunk-3-1.pdf)<!-- --> 
...
##        x1         x2           y
##    <fctr>      <dbl>       <dbl>
## 1       A 0.78516369 -0.01968172
## 2       A 0.50955770 -0.13679640
## 3       A 0.51715646  1.90714430
## 4       A 0.13952898  0.12058585
## 5       A 0.90834627 -2.28852745
## 6       A 0.20532957 -0.97523001
## 7       A 0.95920938 -0.16351889
## 8       A 0.05243847 -0.51525584
## 9       A 0.94724702 -0.51729488
## 10      A 0.54144104 -0.06095520
## # ... with 20 more rows
```
...
##  -0.4729341   0.5458732   0.3690581   0.3737026
```
...
##  0.05070112  0.14267582 -0.80745932 -0.56717053  0.74616981  2.20483281
```
...
sqrt(sum(resid(mod_8) ^ 2)) # incorrect RMSE for Model 8
```
...
```r
sqrt(sum(resid(mod_7) ^ 2)) # RMSE for Model 7
```
...
```r
sqrt(sum(exp(resid(mod_8)) ^ 2)) # correct RMSE for Model 8
```
