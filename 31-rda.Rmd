...
The RMarkdown file for this chapter can be found [**here**](31-rda.Rmd). The file was created using `R` version `r paste0(version$major, "." ,version$minor)` and the following packages:
