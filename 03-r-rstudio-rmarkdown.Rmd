...
Materials for leaning `R`, RStudio, and RMarkdown can be found in another text from the same author, [Applied Statistics with `R`](http://daviddalpiaz.github.io/appliedstats/).
